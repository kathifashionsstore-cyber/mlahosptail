...
export const servicesData = [
  // --- 1. General Bone & Joint Health ---
  {
    ...
    cluster: "bone-health",
    metaTitle: "Osteoporosis Treatment in Narasaraopet | Amulya Hospital",
    metaDescription: "Expert diagnosis and treatment for osteoporosis and weak bones — bone density testing, medication, and fracture prevention at Amulya Hospital.",
  ...
  },
  {
    ...
    categoryId: "orthopaedics",
    cluster: "bone-health",
    metaTitle: "Arthritis & Osteoarthritis Treatment in Narasaraopet | Amulya Hospital",
    metaDescription: "Advanced osteoarthritis care — from physiotherapy and pain management to joint replacement — at Amulya Hospital's Spine, Joint & Trauma Care center.",
  ...
  },
  {
    ...
    categoryId: "orthopaedics",
    cluster: "bone-health",
    metaTitle: "Rheumatoid Arthritis Treatment in Narasaraopet | Amulya Hospital",
  ...
  },
  {
    ...
    categoryId: "orthopaedics",
    cluster: "bone-health",
    metaTitle: "Gout Treatment in Narasaraopet | Amulya Hospital",
    metaDescription: "Fast relief and long-term management for gout attacks — diagnosis, treatment, and joint care at Amulya Hospital.",
    ...
    description: "Gout is a form of inflammatory arthritis caused by the buildup of uric acid crystals within a joint, most classically the big toe. It typically presents as sudden, intense pain, swelling, and redness in the affected joint, often striking at night and reaching peak severity within hours. Uric acid is a natural waste product, but when levels in the blood become too high (hyperuricemia), it can crystallize and deposit in joints, triggering an intense inflammatory response. Without management, gout can become recurrent and, over time, lead to chronic joint damage and visible uric acid deposits called tophi. At Amulya Hospital, we focus on both rapid relief during an acute attack and long-term strategies to prevent recurrence and protect joint health.",
    causes: [
